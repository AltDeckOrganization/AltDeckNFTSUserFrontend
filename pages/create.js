...
const Create = () => {
    ...
    return (
        <main className='min-h-[100vh] py-10 w-[610px] mx-auto'>
            <h1
                className='font-semibold text-center text-[26px] mb-10'
            >Create new Item</h1>
            <h3
            ...
            >
                <p
                    className='text-[20px] text-black1 font-medium'
                >JPG, PNG, GIF</p>
                <img src='/images/upload-icon.svg' alt='' />
                <div className="flex flex-col items-center space-y-1">
                    <p className='text-[14px] text-black1 font-semibold'>Drag and Drop File</p>
                    <p className='text-black1 text-[14px]'>or 
                        <span className='ml-1 font-semibold'>browse media on your device</span>
                    </p>
                </div>
                <input 
                    ref={inputFile}
            ...
            <h3
                className='font-medium text-[20px] mb-4 mt-20'
            >Select media type</h3>
            <CustomSelect 
            ...
            />
            <h3
               className='font-medium text-[20px] mb-4 mt-10' 
            >
            ...
            >
                Royalties ensure that you continue to get compensated for your work after its
                initial sale.
            </p>
            <h4
                className='font-medium text-[18px] mb-1 mt-4'
            >
                Royalty percentage
            </h4>
            <p
            ...
            <h4
                className='font-medium text-[18px] mb-1 mt-6'
            >
                Creators split
            </h4>
            <p
            ...
            <div
                className='flex flex-row items-end justify-end mt-14'
            >
                <button
                    className='px-5 py-2 font-medium text-white bg-primary text-[14px] rounded-md'
                >
                    Create Item
                </button>
            </div>
