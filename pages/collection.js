    ...
    return (
        <div> 
            ...
            <div className=' text-center collection__p text-sm'>
                Deep in the heart of Dingus Forest echoes the sleepless cries of a troop of 10,000 apes. 
                These aren’t just regular apes, however. These are degenerate apes.
            </div>
                    ...
                    <div className='flex bg-gray-300 p-7 rounded-lg  justify-between'>
                        <div className='flex justify-center justify-items-center'>
                            <Image 
                                ...
                                alt="filters"
                            />
                            <div className='text-sans uppercase pl-2 text-xs text-gray-500'>Filters</div>
                        </div>
                        <div className='flex justify-center justify-items-center'>
                            <Image 
                                ...
                                alt="Magnifier"
                            />
                            <div className='text-sans uppercase pl-1 text-xs text-gray-500'>Price: Low to High</div>
                        </div>
                    </div>
