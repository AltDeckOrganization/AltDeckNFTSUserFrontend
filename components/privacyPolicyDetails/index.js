    ...
    <div className={`mt-5 ${styles.privacy_policy_details}`}>
      <div className="text-sm text-[#808080]">
        <p className="leading-loose leading-6 mb-5">
          At AltdeckNFTS, accessible at{" "}
          <Link href="https://altdecknfts.io/">
            <a className="text-[#50C9C3]">altdecknfts.io</a>
          </Link>
          , one of our main priorities is the privacy of our visitors. This
          Privacy Policy document contains types of information that is
          collected and recorded by AltdeckNFTS and how we use it.
        </p>
        <p className="leading-loose leading-6 mb-5">
          If you have additional questions or require more information about our
          Privacy Policy, do not hesitate to contact us through email at{" "}
          <Link href="contact@altdecknfts.io ">
            <a className="text-[#50C9C3]">contact@altdecknfts.io </a>
          </Link>
          contact@altdecknfts.io This privacy policy applies only to our online
          activities and is valid for visitors to our website with regards to
          the information that they shared and/or collect in AltdeckNFTS. This
...
The personal information that you are asked to provide, and the reasons why you are asked to provide it, will be made clear to you at the point we ask you to provide your personal information."
        ...
        <TosPara
          title="Log Files"
          desc="AltdeckNFTS follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website, and gathering demographic information."
        />
        <TosPara
          title="Cookies and Web Beacons"
          desc="Like any other website, AltdeckNFTS uses ‘cookies'. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information."
        />
        <div>
          <p
          ...
          <p className="leading-loose leading-6 mb-5">
            ...
            <Link href="www.altdecknfts.io">
              <a className="text-[#50C9C3]">www.altdecknfts.io</a>
            </Link>{" "}
        ...
        <TosPara
          ...
          desc="You may consult this list to find the Privacy Policy for each of the advertising partners of AltdeckNFTS."
        />
        <p className="leading-loose leading-6 mb-5">
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on AltdeckNFTS, which are sent
          ...
          AltdeckNFTS has no access to or control over these cookies that are
          used by third-party advertisers.
        </p>
        <p className="leading-loose leading-6 mb-5">
          <span className="font-bold">Note </span> that AltdeckNFTS has no
          access to or control over these cookies that are used by third-party
          advertisers.
        </p>
        <TosPara
          title="Third-Party Privacy Policies"
          desc="AltdeckNFTS's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options. You may find a complete list of these Privacy Policies and their links here: Privacy Policy Links.
...
Another part of our priority is adding protection for children while using the internet. We encourage parents and guardians to observe, participate in, and/or monitor and guide their online activity."
          ...
          <p className="leading-loose leading-6 mb-5">
            AltdeckNFTS does not knowingly collect any Personal Identifiable
